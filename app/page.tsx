  ...
  return (
    <>
      <div className="bg-slate-50 overflow-x-hidden">
              ...
              <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
                ...
                <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                  ...
                  <div className="flex flex-col justify-between items-center sm:items-start">
                    <div className="flex gap-0.5 [&_svg]:text-green-600 [&_svg]:size-4 [&_svg]:fill-green-600">
                      <Star />
                      <Star />
                      <Star />
                      <Star />
        ...
        {/* view proposition section */}

        <section className="bg-slate-100 py-24">
          <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
            <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6 relative">
              ...
              <Image
                ...
                height={86}
                src="/snake-2.png"
                className="w-24 order-0 lg:order-2 animate-bounce"
                alt="snake image"
              />
            </div>
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
              <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                <div className="flex gap-0.5 mb-2 [&_svg]:size-5 [&_svg]:text-green-600 [&_svg]:fill-green-600">
                  <Star />
                  <Star />
                  <Star />
                  <Star />
        ...
        <section>
          <MaxWidthWrapper className="py-24">
            ...
            <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit [&_li]:w-fit [&_svg]:size-5 [&_svg]:text-green-600 [&_svg]:inline [&_svg]:mr-1.5">
              <li>
                <Check />
              ...
              <div className="flex justify-center">
                ...
                >
                  ...
                  <ArrowRight className="size-4 ml-1.5 !text-white animate-flashing" />
                </Link>
              </div>
            </ul>
          </MaxWidthWrapper>
